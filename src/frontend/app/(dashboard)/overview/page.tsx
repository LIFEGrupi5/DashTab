...
import { TrendingUp, ShoppingBag, CheckCircle2, Clock, Wallet, TriangleAlert } from 'lucide-react';
...
export default function OverviewPage() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      icon: Wallet,
      color: 'bg-emerald-50 text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-200',
    },
    {
      ...
      <div className="bg-white dark:bg-card rounded-xl border border-neutral-200 dark:border-border p-5 mt-6">
        <div className="flex items-start justify-between mb-1">
          <div>
              ...
              <RadixTooltip.Provider delayDuration={200}>
                <RadixTooltip.Root>
                  <RadixTooltip.Trigger asChild>
                    <button type="button" className="text-neutral-400 hover:text-neutral-500 dark:text-muted-foreground dark:hover:text-neutral-400 transition">
                  ...
                  <RadixTooltip.Portal>
                    ...
                    >
                      Accuracy improves over time. This model learns from your order history — predictions will be unreliable at first and become more accurate as more data is collected.
            ...
            <p className="text-xs text-neutral-400 dark:text-muted-foreground mt-0.5">7-day prediction — powered by ML model</p>
          </div>
